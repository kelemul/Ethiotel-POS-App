...
POS_COUPON_PATH = REPO_ROOT / "ethiotel_pos" / "ethiotel_pos" / "doctype" / "pos_coupon" / "pos_coupon.py"
...
def _load_pos_coupon_module():
    module_name = "ethiotel_pos.ethio_telecom_pos_app.doctype.pos_coupon.pos_coupon"
