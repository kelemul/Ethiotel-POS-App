...
from ethiotel_pos.ethio_telecom_pos_app.doctype.pos_closing_shift.closing_processing import creation, overview
...
class TestClosingShiftCashMovementIntegration(unittest.TestCase):
    @patch("ethiotel_pos.ethio_telecom_pos_app.doctype.pos_closing_shift.closing_processing.creation.get_payments_entries")
    @patch("ethiotel_pos.ethio_telecom_pos_app.doctype.pos_closing_shift.closing_processing.creation.get_pos_invoices")
    @patch(
        "ethiotel_pos.ethio_telecom_pos_app.doctype.pos_closing_shift.closing_processing.creation.submit_printed_invoices"
    )
    @patch("ethiotel_pos.ethio_telecom_pos_app.doctype.pos_closing_shift.closing_processing.creation.frappe")
    ...
    @patch("ethiotel_pos.ethio_telecom_pos_app.doctype.pos_closing_shift.closing_processing.overview.get_payments_entries")
    @patch("ethiotel_pos.ethio_telecom_pos_app.doctype.pos_closing_shift.closing_processing.overview.get_pos_invoices")
    @patch("ethiotel_pos.ethio_telecom_pos_app.doctype.pos_closing_shift.closing_processing.overview.frappe.get_all")
    @patch("ethiotel_pos.ethio_telecom_pos_app.doctype.pos_closing_shift.closing_processing.overview.frappe.db.get_value")
    @patch("ethiotel_pos.ethio_telecom_pos_app.doctype.pos_closing_shift.closing_processing.overview.frappe.get_cached_value")
    @patch("ethiotel_pos.ethio_telecom_pos_app.doctype.pos_closing_shift.closing_processing.overview.frappe.get_doc")
