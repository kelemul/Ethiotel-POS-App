...
from ethiotel_pos.ethio_telecom_pos_app.doctype.pos_closing_shift.closing_processing import creation, invoices, overview
...
class TestPOSClosingShift(unittest.TestCase):
    ...
    @patch("ethiotel_pos.ethio_telecom_pos_app.doctype.pos_closing_shift.closing_processing.overview.frappe")
    ...
    @patch("ethiotel_pos.ethio_telecom_pos_app.doctype.pos_closing_shift.closing_processing.invoices.frappe")
