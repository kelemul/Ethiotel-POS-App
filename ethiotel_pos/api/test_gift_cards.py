...
def _install_stubs():
    ...
    employees_module = types.ModuleType("ethiotel_pos.api.employees")
    ...
    sys.modules["ethiotel_pos.api.employees"] = employees_module
...
def _load_module():
    module_name = "ethiotel_pos.api.gift_cards"
    file_path = REPO_ROOT / "ethiotel_pos" / "ethiotel_pos" / "api" / "gift_cards.py"
