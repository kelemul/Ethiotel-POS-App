...
def _install_stubs():
    ...
    pricing_module = types.ModuleType("ethiotel_pos.api.pricing_rules")
    ...
    sys.modules["ethiotel_pos.api.pricing_rules"] = pricing_module
...
def _load_module():
    ...
    file_path = REPO_ROOT / "ethiotel_pos" / "ethiotel_pos" / "api" / "offline_sync" / "pricing_rules.py"
