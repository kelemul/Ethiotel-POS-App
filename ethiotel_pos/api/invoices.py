...
import frappe
import time
from ethiotel_pos.api.erpnext_compat import resolve_make_sales_invoice_from_order
...
from ethiotel_pos.api.invoice_processing.creation import (
    update_invoice,
    submit_invoice,
...
from ethiotel_pos.api.invoice_processing.returns import (
...
from ethiotel_pos.api.invoice_processing.data import get_last_invoice_rates
from ethiotel_pos.api.utils import log_perf_event
...
def delete_invoice(invoice):
    ...
    from ethiotel_pos.api.invoice import delete_invoice_submission_ledger_entries_for_invoice
