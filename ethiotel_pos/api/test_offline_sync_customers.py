...
def _install_stubs():
    ...
    customers_module = types.ModuleType("ethiotel_pos.api.customers")
    ...
    sys.modules["ethiotel_pos.api.customers"] = customers_module


def _load_module():
    module_name = "test_offline_sync_customers_target"
    file_path = REPO_ROOT / "ethiotel_pos" / "ethiotel_pos" / "api" / "offline_sync" / "customers.py"
...
def _load_common_module():
    return sys.modules["ethiotel_pos.api.offline_sync.common"]
