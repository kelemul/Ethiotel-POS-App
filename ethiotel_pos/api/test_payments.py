...
def _install_stubs():
    ...
    erpnext_compat = types.ModuleType("ethiotel_pos.api.erpnext_compat")
    ...
    sys.modules["ethiotel_pos.api.erpnext_compat"] = erpnext_compat

    return created_docs, get_all_responses, sql_responses, get_doc_responses, reconcile_calls


def _load_payments_module():
    module_name = "ethiotel_pos.api.payments"
    file_path = REPO_ROOT / "ethiotel_pos" / "ethiotel_pos" / "api" / "payments.py"
