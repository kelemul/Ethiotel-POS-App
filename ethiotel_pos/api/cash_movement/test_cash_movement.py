...
from ethiotel_pos.api.cash_movement import queries, service, validation


class TestCashMovementValidation(unittest.TestCase):
    @patch("ethiotel_pos.api.cash_movement.validation.frappe")
...
class TestCashMovementService(unittest.TestCase):
    @patch("ethiotel_pos.api.cash_movement.service.parse_payload")
    @patch("ethiotel_pos.api.cash_movement.service.get_opening_shift")
    @patch("ethiotel_pos.api.cash_movement.service.get_pos_profile")
    @patch("ethiotel_pos.api.cash_movement.service.validate_company_consistency")
    @patch("ethiotel_pos.api.cash_movement.service.ensure_feature_enabled")
    @patch("ethiotel_pos.api.cash_movement.service.ensure_movement_allowed")
    @patch("ethiotel_pos.api.cash_movement.service.validate_amount")
    @patch("ethiotel_pos.api.cash_movement.service.validate_remarks")
    @patch("ethiotel_pos.api.cash_movement.service.ensure_no_duplicate_client_request")
    @patch("ethiotel_pos.api.cash_movement.service.resolve_source_cash_account")
    @patch("ethiotel_pos.api.cash_movement.service.resolve_target_account")
    @patch("ethiotel_pos.api.cash_movement.service.validate_account_company")
    @patch("ethiotel_pos.api.cash_movement.service.create_journal_entry", create=True)
    @patch("ethiotel_pos.api.cash_movement.service.frappe")
    ...
    @patch("ethiotel_pos.api.cash_movement.service._create_cash_movement")
    @patch("ethiotel_pos.api.cash_movement.service.ensure_owner_or_manager")
    @patch("ethiotel_pos.api.cash_movement.service.frappe")
...
class TestCashMovementQueries(unittest.TestCase):
    @patch("ethiotel_pos.api.cash_movement.queries.frappe.get_all")
