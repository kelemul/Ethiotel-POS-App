...
CUSTOMERS_API_PATH = REPO_ROOT / "ethiotel_pos" / "ethiotel_pos" / "api" / "customers.py"
...
def _install_stubs():
    ...
    stored_value_module = types.ModuleType("ethiotel_pos.api.stored_value")
    ...
    sys.modules["ethiotel_pos.api.stored_value"] = stored_value_module

    return state


def _load_module():
    module_name = "ethiotel_pos.api.customers"
