...
def _install_stubs():
    ...
    creation_module = types.ModuleType("ethiotel_pos.api.invoice_processing.creation")
    ...
    sys.modules["ethiotel_pos.api.invoice_processing.creation"] = creation_module


def _load_module():
    module_name = "test_offline_sync_invoices_target"
    file_path = REPO_ROOT / "ethiotel_pos" / "ethiotel_pos" / "api" / "offline_sync" / "invoices.py"
