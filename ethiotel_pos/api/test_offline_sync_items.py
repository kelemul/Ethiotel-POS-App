...
def _install_stubs():
    ...
    items_module = types.ModuleType("ethiotel_pos.api.items")
    ...
    sys.modules["ethiotel_pos.api.items"] = items_module
    sys.modules["ethiotel_pos.api.offline_sync.common"] = load_offline_sync_common()


def _load_module():
    module_name = "test_offline_sync_items_target"
    file_path = REPO_ROOT / "ethiotel_pos" / "ethiotel_pos" / "api" / "offline_sync" / "items.py"
