...
from ethiotel_pos.api.item_fetchers import ItemDetailAggregator
...
from ethiotel_pos.api.item_processing.barcode import search_serial_or_batch_or_barcode_number
from ethiotel_pos.api.item_processing.details import get_items_details
