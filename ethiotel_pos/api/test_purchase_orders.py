...
def _install_stubs():
    ethiotel_pos_pkg = types.ModuleType("ethiotel_pos")
    ethiotel_pos_pkg.__path__ = [str(REPO_ROOT / "ethiotel_pos")]
    sys.modules.setdefault("ethiotel_pos", ethiotel_pos_pkg)

    ethiotel_pos_inner_pkg = types.ModuleType("ethiotel_pos")
    ethiotel_pos_inner_pkg.__path__ = [str(REPO_ROOT / "ethiotel_pos" / "ethiotel_pos")]
    sys.modules.setdefault("ethiotel_pos", ethiotel_pos_inner_pkg)

    ethiotel_pos_api_pkg = types.ModuleType("ethiotel_pos.api")
    ethiotel_pos_api_pkg.__path__ = [str(REPO_ROOT / "ethiotel_pos" / "ethiotel_pos" / "api")]
    sys.modules.setdefault("ethiotel_pos.api", ethiotel_pos_api_pkg)
...
def _load_module():
    module_name = "ethiotel_pos.api.purchase_orders"
    file_path = REPO_ROOT / "ethiotel_pos" / "ethiotel_pos" / "api" / "purchase_orders.py"
