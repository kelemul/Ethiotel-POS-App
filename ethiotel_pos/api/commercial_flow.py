...
from ethiotel_pos.api.erpnext_compat import (
...
from ethiotel_pos.api.invoices import get_draft_invoices
from ethiotel_pos.api.quotations import search_quotations, submit_quotation
from ethiotel_pos.api.sales_orders import search_orders
